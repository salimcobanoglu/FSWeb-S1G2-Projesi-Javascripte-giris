...
if(birinciDeger=>ikinciDegeri){(birinciDeger=Math.random)};
...
let myInteger = parseInt(stringDegisken);
...
1. Bilgisayarın seçimini rastgele oluşturacağımız bir fonksiyon tanımlayın. 
Örn: 
...
function notHesapla(notun){
  ...
  if (notun >= 90 ) {return 'A aldın';
  } else if (notun >= 80) {return'B aldın';
  } else if (notun >= 70) {return'C aldın';
  } else if (notun >= 60) {return'D aldın';
  } else {return'F aldın';
  }
